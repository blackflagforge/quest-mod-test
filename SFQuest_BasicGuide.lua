...
ExampleTiersTemplate = { 
	{tiername = "IGUI_Factions_Template_Tier1", minrep = 700, barcolor = "red"}, 
	{tiername = "IGUI_Factions_Template_Tier2", minrep = 1400, barcolor = "orange"}, 
	{tiername = "IGUI_Factions_Template_Tier3", minrep = 2100, barcolor = "yellow"}, 
	{tiername = "IGUI_Factions_Template_Tier4", minrep = 2800, barcolor = "green"} };
