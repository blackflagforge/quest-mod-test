...
manager:getItem("Base.Antibiotics"):DoParam("Tags".." = ".. "Medicine");
...
manager:getItem("Base.SutureNeedleHolder"):DoParam("Tags".." = ".. "FirstAid");
manager:getItem("Base.Splint"):DoParam("Tags".." = ".. "FirstAid");
manager:getItem("Base.Bandage"):DoParam("Tags".." = ".. "FirstAid");
